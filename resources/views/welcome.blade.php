        ...
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
            <ul>
                ...
                <li data-transition="crossfade">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('public/frontend/images/slider/oferta-compartida.jpg') }}" 
                         alt="Oferta habitación compartida" 
                         title="Oferta habitación compartida" 
                ...
                <li data-transition="crossfade">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('public/frontend/images/slider/oferta-matrimonial.jpg') }}" 
                         alt="Oferta habitación matrimonial" 
                         title="Oferta habitación matrimonial" 
                         data-bgposition="center center" 
                         data-bgfit="cover" 
                         data-bgrepeat="no-repeat" 
                         data-bgparallax="10" 
