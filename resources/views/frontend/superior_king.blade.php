...
@section('content')
      ...
      <div class="page-title op5">
        <div class="container">
          <div class="inner">
            <h1>HABITACIÓN KING SUPERIOR</h1>
            <ol class="breadcrumb">
              <li>
                <a href="{{ url('/') }}">Inicio</a>
              </li>
